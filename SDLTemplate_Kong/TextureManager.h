...
public:
	...
	// drawing functions
	void draw(const std::string& id, int x, int y, double angle = 0, int alpha = 255, SDL_RendererFlip flip = SDL_FLIP_NONE);
	...
	void drawText(const std::string& id, int x, int y, double angle, int alpha = 255, SDL_RendererFlip flip = SDL_FLIP_NONE);
