...
bool CollisionManager::squaredRadiusCheck(GameObject* object1, GameObject* object2)
{
	...
	{
		object1->getRigidBody().setIsColliding(true);
		object2->getRigidBody().setIsColliding(true);
	...
	else
	{
		...
		object1->getRigidBody().setIsColliding(false);
		object2->getRigidBody().setIsColliding(false);
		return false;
	}
}
